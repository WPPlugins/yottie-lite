...
=== YouTube Gallery - Video Gallery for YouTube ===
Contributors: elfsight
Donate link: https://elfsight.com/youtube-channel-plugin-yottie/?utm_source=markets&utm_medium=wordpressorg&utm_campaign=yottie-lite&utm_term=donate&utm_content=description
Tags: youtube, Youtube channel, youtube for website, youtube gallery, youtube player, youtube playlist, youtube plugin, youtube shortcode, youtube widget, youtube wordpress, youtube carousel, youtube stream, youtube subscribe, embed youtube, youtube video, youtube feed, YouTube API, youtube galleries, import youtube videos, lightbox youtube, youtube html, YouTube Live, youtube slider, youtube post, free youtube plugin, best youtube widget, download youtube gallery
...
**[YouTube Gallery Yottie Lite](https://elfsight.com/youtube-channel-plugin-yottie/?utm_source=markets&utm_medium=wordpressorg&utm_campaign=yottie-lite&utm_term=common&utm_content=description)**
**[Live Demo](https://elfsight.com/youtube-channel-plugin-yottie/?utm_source=markets&utm_medium=wordpressorg&utm_campaign=yottie-lite&utm_term=editor&utm_content=description#preview)**
...
> Try all features of Pro YouTube gallery plugin for WordPress: [Live Demo](https://elfsight.com/youtube-channel-plugin-yottie/?utm_source=markets&utm_medium=wordpressorg&utm_campaign=yottie-lite&utm_term=editor&utm_content=description#preview)
...
**Check The Premium Version of Our YouTube Plugin in [Live Demo](https://elfsight.com/youtube-channel-plugin-yottie/?utm_source=markets&utm_medium=wordpressorg&utm_campaign=yottie-lite&utm_term=editor&utm_content=description#preview)**
...
You can read the **[installation guide](https://elfsight.com/blog/2016/04/how-to-add-youtube-video-to-wordpress-website/?utm_source=markets&utm_medium=wordpressorg&utm_content=installation&utm_campaign=yottielite)** of the WordPress channel plugin in our Elfsight blog. Please, note that the first installation step in our article relates only to the [premium version of Yottie](https://elfsight.com/youtube-channel-plugin-yottie/?utm_source=markets&utm_medium=wordpressorg&utm_campaign=yottie-lite&utm_term=common&utm_content=description). After downloading the free version, you have to start right from the second step.
...
1. Download `yottie-lite.1.2.0.zip` from `wordpress.org` and unzip it
...
We’ve created a special web page with the Online Demo on it. Just follow this [link](https://elfsight.com/youtube-channel-plugin-yottie/?utm_source=markets&utm_medium=wordpressorg&utm_campaign=yottie-lite&utm_term=editor&utm_content=description#preview) and play with all features of our YouTube gallery plugin.
...
Actually, [Yottie Pro](https://elfsight.com/youtube-channel-plugin-yottie/?utm_source=markets&utm_medium=wordpressorg&utm_campaign=yottie-lite&utm_term=common&utm_content=description) has 3 video play modes including opening in popup. Inline mode plays videos right in the YouTube gallery without any additional actions. YouTube mode opens videos particularly in the largest hosting.
...
Yottie Pro has so many parameters that it takes time to think out values of all YouTube plugin's parameters. We've prepared [several examples](https://elfsight.com/youtube-channel-plugin-yottie/?utm_source=markets&utm_medium=wordpressorg&utm_campaign=yottie-lite&utm_term=common&utm_content=description) of how Yottie can be used on a WordPress website.
...
= Real Usage of YouTube Plugin Pro =

[http://toyzone.hu/bruder-videok/](http://toyzone.hu/bruder-videok/) - Our Premium YouTube Gallery plugin displays reviews of cool cars and trucks from the toy company. 2 custom playlists, all videos can be opened in popup. Everything looks just fine to attract more potential customers interested in your brand using YouTube!

[http://www.invincibletricking.co/videos/](http://www.invincibletricking.co/videos/) - Attractive shop uses our YouTube Plugin to stream their own channel on the website. The plugin was fitted perfectly and now has custom groups made for the easiest orientation among company’s spots. Yottie is a great way to earn more audience engagements on your site.

[http://www.mariomonforte.com/youtube/](http://www.mariomonforte.com/youtube/) - Almost full-screen sized usage of Yottie makes look like an astonishing web source. Installing our plugin you will get the channel with an automatically updated content from YouTube. Don’t forget to customize it for the best user experience in order to maintain the full power of YouTube!

[http://www.sonidosbinaurales.com/escuchar-tonos-binaurales-gratis/](http://www.sonidosbinaurales.com/escuchar-tonos-binaurales-gratis/) – It’s relaxation time! Our YouTube plugin is used to display music videos. Basic style, various custom video groups – you get an extremely useful YouTube tool, which allows audience to watch any video without leaving your website.

[http://followmy.ru/youtube/](http://followmy.ru/youtube/) – Our plugin is used several times on a web page in order to show various note-worthy YouTube channels, which might be interesting to subscribe. Each YouTube channel is displayed separately and has some general description. This example is a perfect demonstration of Yottie’s multiple usage. Each time you can set different settings and different sources.
